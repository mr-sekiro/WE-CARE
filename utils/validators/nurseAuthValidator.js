...
exports.forgotPasswordNurseValidator = [
  check("email")
    .notEmpty()
    .withMessage("email of nurse is required")
    .customSanitizer((value) => value.replace(/\s/g, ""))
...
exports.resetPasswordValidator = [
  check("newPassword")
    .notEmpty()
    .withMessage("New password of nurse required")
    .isLength({ min: 8 })
    .withMessage("Password must be at least 8 characters"),
  check("passwordConfirm")
    .notEmpty()
    .withMessage("New password confirmation of nurse required")
